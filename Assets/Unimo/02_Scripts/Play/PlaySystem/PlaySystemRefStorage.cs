...
public class PlaySystemRefStorage : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (mapSetter == null)
        {
            Debug.Log("MapSetter not found.");
        }

        if (playTimeManager == null)
        {
            Debug.Log("Time Manage not found.");
        }

        if (playProcessController == null)
        {
            Debug.Log("process Ctrl not found.");
        }
        ...
        if (harvestLvController == null)
        {
            Debug.Log("harvest Lv ctrl not found.");
        }*/
    }
}
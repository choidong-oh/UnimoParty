...
public class FlowerFXController : MonoBehaviour
{
    ...
    protected GameObject harvestVFX;

    [SerializeField]
    
    protected AudioSource harvestSFX;
    ...
    protected void Start()
    {
        ...
        transform.localScale = (1f + scale) * Vector3.one;
    }
    
    public virtual void TriggerHarvestFX(float hLvRatio)
    {
    ...
    public virtual void SetFlowerActivate(bool activate)
    {
    ...
    protected virtual IEnumerator HarvestFXCoroutine()
    {

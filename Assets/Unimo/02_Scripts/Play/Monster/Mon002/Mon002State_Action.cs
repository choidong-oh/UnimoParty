...
public class Mon002State_Action : MonsterState_Action
{
    ...
    private float audioStartDist = 15f;

    [SerializeField]
    
    private float waitTimebeforeDeactive = 1.5f;
    ...
    public override void TransitionAction(MonsterController controller)
    {
        ...
        {
            rigidbody.velocity = dashSpeed * controller.transform.forward;
        }
    }
    ...
    public override void UpdateAction()
    {
        ...
        if (waitTimebeforeDeactive >= 0f)
        {
            waitTimebeforeDeactive -= Time.deltaTime;
        }
        ...
        else
        {
            ...
            if (dist < audioStartDist && audioSource.enabled == false)
            {

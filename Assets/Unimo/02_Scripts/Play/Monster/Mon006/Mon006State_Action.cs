...
public class Mon006State_Action : MonsterState_Action
{
    ...
    private GameObject laserFXObj;

    [SerializeField]
    
    private GameObject laserEndFXObj;

    [SerializeField]
    
    private LineRenderer laserBodyRender;

    [SerializeField]
    
    private Custom3DAudio fireSFX3D;

    [SerializeField]
    
    private Custom3DAudio shootSFX3D;

    [SerializeField]
    
    private float fireDuration = 2.3f;

    [SerializeField]
    
    private float laserWidth = 1.5f;
    ...
    private void hitPlayer()
    {
        ...
        float innerP = laserPivot.forward.x * toPlayerVec.x + laserPivot.forward.y * toPlayerVec.y + laserPivot.forward.z * toPlayerVec.z;

...
public class MonGenCalculator : ScriptableObject
{
    ...
    private float minimumGentime = 1f; //Basic spawn time is controlled using sigmoid decay

    [SerializeField]
    
    private float genDecayingTime = 100f;

    [SerializeField]
    
    private float defaultGentime = 4.5f;

    [SerializeField]
    
    private float bigWaveGenMaxReduce = 0.3f;
    ...
    private float minimumBigWavetime = 25f; //BigWave call time is controlled using linear decay

    [SerializeField]
    
    private float bigWaveDecreasingTime = 240f;

    [SerializeField]
    
    private float defaultBigWavetime = 50f;

    [SerializeField]
    
    private float minimumBigWaveDuration = 15f; //BigWave duration is controlled using linear decay proportional to BigWave call time changes

    [SerializeField]
    
    private float defaultBigWaveDuration = 25f;
